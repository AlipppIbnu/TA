...
const SidebarComponent = ({ 
  ...
  return (
    <>
      ...
      <aside className={`fixed top-0 h-full bg-white/95 backdrop-blur-sm border-r border-gray-200 shadow-xl z-20 transition-all duration-300 ${
      ...
      {/* Toggle Button - Floating over map */}
      <button
        onClick={() => setIsSidebarVisible(!isSidebarVisible)}
        className="fixed top-6 bg-white/90 backdrop-blur-sm border border-gray-200 rounded-lg p-2.5 shadow-lg hover:shadow-xl hover:bg-white transition-all duration-200 z-30"
        style={{
