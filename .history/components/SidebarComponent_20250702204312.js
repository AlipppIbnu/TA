            ...
            <div className="p-2 border-t border-gray-200">
              <div className="space-y-2">
                ...
                <button 
                  ...
                  className="w-full p-3 text-gray-600 hover:text-blue-600 hover:bg-gray-100 rounded-lg transition-colors relative group"
                >
                  <svg className="w-6 h-6 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                >
                  <svg className="w-6 h-6 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 17h5l-5-5-5 5h5zM15 17v3a2 2 0 01-2 2h-2a2 2 0 01-2-2v-3" />
