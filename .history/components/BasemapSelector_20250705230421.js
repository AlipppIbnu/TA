// components/BasemapSelector.js
import { useState, useEffect } from 'react';
import { createPortal } from 'react-dom';
import Image from 'next/image';

const BasemapSelector = ({ onStyleChange, currentStyle = 'streets' }) => {
  ...
  return (
    <>
      {/* Basemap Toggle Button - Floating style matching sidebar toggle */}
      <button
        ...
        style={{
          left: '360px' // Positioned after sidebar toggle button
        }}
