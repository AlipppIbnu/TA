...
export default function Dashboard() {
  ...
  return (
    <div className="h-screen bg-gray-900 relative overflow-hidden">
      ...
      {/* Floating Sidebar - Using SidebarComponent */}
      <SidebarComponent 
        vehicles={updatedVehicles}
      ...
      {!isDrawingMode && (
        <header className="absolute top-4 right-4 z-40 bg-white/90 backdrop-blur-sm rounded-lg shadow-lg border border-gray-200 px-4 py-3">
      ...
      <div className={`absolute right-4 z-50 space-y-1.5 max-w-[220px] w-full transition-all duration-300 ${
